...
__declspec(dllexport) LevelTxt* d2common_get_level_text(D2Version gameVersion, int levelCode) {
...
__declspec(dllexport) void d2common_init_level(D2Version gameVersion, Level* pLevel) {
...
__declspec(dllexport) void d2common_add_room_data(D2Version gameVersion, Act* pAct, Level* pLevel, Room2* pRoom2) {
...
__declspec(dllexport) void d2common_remove_room_data(D2Version gameVersion, Act* pAct, Level* pLevel, Room2* pRoom2) {
    if (gameVersion == VersionPathOfDiablo) return D2COMMON_Pod_AddRoomData(pAct, pLevel->dwLevelNo, pRoom2->dwPosX, pRoom2->dwPosY, NULL);
    if (gameVersion == VersionProjectDiablo2) return D2COMMON_Pd2_AddRoomData(pAct, pLevel->dwLevelNo, pRoom2->dwPosX, pRoom2->dwPosY, NULL);
    if (gameVersion == VersionDiablo2) return D2COMMON_Pd2_AddRoomData(pAct, pLevel->dwLevelNo, pRoom2->dwPosX, pRoom2->dwPosY, NULL);
}

__declspec(dllexport) Level* d2common_get_level(D2Version gameVersion, ActMisc *misc, DWORD levelCode) {
...
__declspec(dllexport) ObjectTxt* d2common_get_object_txt(D2Version gameVersion, DWORD dwTxtFileNo) {
